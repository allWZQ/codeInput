 ...
 */
export const SuperPhotoLoupe = (props) => {
  // 图片信息
  ...
  return (
    <div id="mydiv" style={{ position: 'relative' }}>
      <div style={Object(ClassObj.imgContainer)}>
        <img src={imgUrl} width="100%" height="100%" alt="图片加载失败" />
        <div
          style={Object(ClassObj.maskBlock)}
          onMouseEnter={mouseEnter}
          onMouseLeave={mouseLeave}
          onMouseMove={mouseMove}
        />
        {magnifierOff && <div style={Object(mouseBlock)} />}
      </div>

      {magnifierOff && (
        <div style={Object(magnifierMemo)}>
          <img style={Object(imgStyle)} src={imgUrl} alt="图片加载失败" />
        </div>
      )}
    </div>
  );
